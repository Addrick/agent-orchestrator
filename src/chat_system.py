...
class ChatSystem:
    ...
    async def generate_response(
        ...
        if command_result:
            ...
            response_type = ResponseType.DEV_COMMAND if mutated else ResponseType.DEV_COMMAND_INFO
            return command_result["response"], response_type, None
