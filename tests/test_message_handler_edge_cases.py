...
async def test_dotted_path_max_nesting_limit(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set kobold.nested.key 42")
...
async def test_dotted_path_empty_provider(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set .key 1")
...
async def test_set_provider_extra_clear_missing(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set kobold.never_set none")
...
async def test_set_unknown_subcommand(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set bogus value")
    assert result is not None and result["mutated"] is False
...
async def test_set_bare_no_args(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set")
...
async def test_set_tokens_non_numeric_fallback(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set tokens abc")
    assert result is not None and result["mutated"] is True
...
async def test_set_temp_out_of_range(bot):
    result = await bot.preprocess_message("derpr", "u1", "set temp 5.0")
    assert result is not None and result["mutated"] is False
...
async def test_set_temp_non_numeric_fallback(bot):
    result = await bot.preprocess_message("derpr", "u1", "set temp hot")
    assert result is not None and result["mutated"] is True
...
async def test_set_top_p_out_of_range(bot):
    result = await bot.preprocess_message("derpr", "u1", "set top_p 1.5")
    assert result is not None and result["mutated"] is False
...
async def test_set_top_p_non_numeric_fallback(bot):
    result = await bot.preprocess_message("derpr", "u1", "set top_p high")
    assert result is not None and result["mutated"] is True
...
async def test_set_top_k_negative_no_validation(bot):
    ...
    """
    result = await bot.preprocess_message("derpr", "u1", "set top_k -5")
    assert result is not None and result["mutated"] is True
...
async def test_set_top_k_non_integer_fallback(bot):
    result = await bot.preprocess_message("derpr", "u1", "set top_k 3.14")
    assert result is not None and result["mutated"] is True
...
async def test_set_execution_mode_invalid_enum(bot):
    result = await bot.preprocess_message("derpr", "u1", "set execution_mode bogus")
    assert result is not None and result["mutated"] is False
...
async def test_set_memory_mode_invalid_enum(bot):
    result = await bot.preprocess_message("derpr", "u1", "set memory_mode nope")
    assert result is not None and result["mutated"] is False
...
async def test_set_tools_none_keyword(bot_with_tools):
    ...
    result = await bot_with_tools.preprocess_message("derpr", "u1", "set tools none")
...
async def test_set_tools_all_bare_names_error(bot_with_tools):
    ...
    result = await bot_with_tools.preprocess_message(
...
async def test_set_tools_all_wildcard(bot_with_tools):
    persona = _persona(bot_with_tools)
    result = await bot_with_tools.preprocess_message("derpr", "u1", "set tools all")
    assert result["mutated"] is True
    assert persona.get_enabled_tools() == ["*"]
...
async def test_set_service_bindings_clear_keyword(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set service_bindings none")
    assert result["mutated"] is True
...
async def test_set_long_term_memory_variants(bot, value, expected):
    result = await bot.preprocess_message(
...
async def test_set_max_context_tokens_low_clamp(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set max_context_tokens 50")
    assert result["mutated"] is True
...
async def test_set_thinking_level_none_clear(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "set thinking_level none")
    assert result["mutated"] is True
...
async def test_set_chat_template_clear_keyword(bot, keyword):
    ...
    result = await bot.preprocess_message("derpr", "u1", f"set chat_template {keyword}")
    assert result["mutated"] is True
...
async def test_what_bare_no_args(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "what")
    assert result is None
...
async def test_what_models_too_many_args(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "what models google extra")
    assert result is None
...
async def test_what_models_vendor_no_match(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "what models nonexistent")
    assert result is None
...
async def test_dump_last_no_history(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "dump_last")
    assert result is not None and result["mutated"] is False
...
async def test_hello_with_args(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "hello there")
    assert result is None
...
async def test_goodbye_with_args(bot):
    ...
    result = await bot.preprocess_message("derpr", "u1", "goodbye now")
    assert result is None
...
async def test_update_models_returns_none(bot, chat_system):
    ...
    with patch(
        ...
        result = await bot.preprocess_message("derpr", "u1", "update_models")
    assert result is not None
    assert result["mutated"] is False
...
async def test_update_models_with_args(bot):
    ...
    with patch("src.message_handler.get_model_list") as mock_get:
        result = await bot.preprocess_message("derpr", "u1", "update_models foo")
    assert result is not None and result["mutated"] is False
...
async def test_trust_non_integer_id(bot, chat_system):
    result = await bot.preprocess_message("derpr", "u1", "trust abc some reason")
    assert result is not None and result["mutated"] is False
...
async def test_trust_not_found(bot, chat_system):
    ...
    result = await bot.preprocess_message("derpr", "u1", "trust 999 some reason")
    assert result is not None and result["mutated"] is False
...
async def test_untrust_non_integer_id(bot, chat_system):
    ...
    result = await bot.preprocess_message("derpr", "u1", "untrust xyz reason")
    assert result is not None and result["mutated"] is False
    assert "Invalid summary_id" in result["response"]
...
async def test_untrust_success_mutates(bot, chat_system):
    ...
    result = await bot.preprocess_message("derpr", "u1", "untrust 7 stale data")
    assert result is not None and result["mutated"] is True
