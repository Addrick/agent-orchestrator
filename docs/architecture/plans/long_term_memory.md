...
Add to `create_schema()` in `src/memory/memory_manager.py` (inside the `schema_sql` executescript block, using `CREATE TABLE IF NOT EXISTS`):
...
In `tests/memory/test_memory_manager.py`:
...
**Files:** `src/memory/memory_manager.py`, `src/embedding_service.py`, `tests/memory/test_memory_manager.py`, `tests/test_embedding_service.py`
...
**Files:** `src/memory/memory_manager.py`, `src/chat_system.py`, `config/global_config.py`, `tests/test_chat_system.py`, `tests/test_memory_retrieval.py`, `tests/integration/test_memory_modes.py`
...
1. **Unit tests**: `pytest tests/memory/test_memory_manager.py tests/test_embedding_service.py tests/agents/test_memory_agent.py tests/test_memory_retrieval.py -v`
